...
@WebServlet("/auth2")
public class FindPasswordAuthServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!AuthenticationKey.equals(auth_number))
        {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("index.jsp?inc=view/signin/find_password_3step.jsp");
