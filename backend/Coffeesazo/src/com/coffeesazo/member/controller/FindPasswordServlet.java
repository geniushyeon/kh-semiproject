...
public class FindPasswordServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("고객 입력 id : "+ id);
		...
		String result = dao.findpwd(id,email);
		...
		if(result != null) {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("index.jsp?inc=view/signin/find_password_2step.jsp");
