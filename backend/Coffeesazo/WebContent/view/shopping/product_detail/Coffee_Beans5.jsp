...
<head>
    ...
    <title>'엘 라우렐 이호'|COFFEESAZO</title>
        ...
        <div id="menu-container">
            <div class="menu-1">
                ...
                <div class="menu-productinfo">
                    ...
                    <img src="../../img/ElLaurelHijo.png" alt="gold">
            ...
            <div class="menu2">
                <img src="../../img/ElLaurelHijo.png" alt="">
                <div class="detail-infomation">
                    <div class="detail-top">
                        <p class="p1">온두라스 '엘라우렐이호'</p>
                            <p class="p2">Honduras'El Laurel Hijo'</p>
                                
                            </div>
                            <div class="detail-mid">
                                <p>국가 : HONDRRAS</p>
                                <p>지역 : DANLI,EL PARAISO</p>
                                <p>농장 : EL LAUREL HIJO</p>
                                <p>농장주 : OSCAR RAMIREZ</p> 
                                <p>재배 고도 : 1,450M</p>
                                <p>품종 : PARAINEMA</p>
