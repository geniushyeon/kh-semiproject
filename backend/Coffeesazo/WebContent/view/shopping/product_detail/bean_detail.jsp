        ...
        <div id="menu-container">
            <div class="menu1">
                <div class="menu-toplogo">
                    ...
                    <h1><a href="wholebean?beanList=${detail.productName}">${detail.fkCategoryIndex}</a></h1>
                </div>
                <div class="menu-toptag">
                    <a href="index.jsp?inc=view/shopping/product/whole_bean.jsp">${detail.fkHashtagIndex}</a>
                </div>
                
                <div class="menu-productinfo">
                    

                    <c:forEach items="${coffeeList}" var="detail">
                    ...
                    <div class="menu-result">
                        ...
                        <p>${detail.productInfo } </p>
                             <!--    <h3>'모리타'</h3>
                                ...
                                <p>배송 기간:이틀 예정</p>
                                <p>[영업일 기준 2일 이내 발송]</p> -->
                                <label for="addcount">${detail.productCount}</label>
            ...
            <div class="menu2">
                ...
                <div class="detail-infomation">
                    <div class="detail-top">
                        <p class="p1">${detail.productName}</p>
